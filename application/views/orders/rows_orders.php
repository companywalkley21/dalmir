                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="dataTables_filter" id="sample-table-2_filter">
                                                        <label>
                                                            Search: <input type="text" aria-controls="sample-table-2">
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                            ...
                                            <tr class="<?php echo  $k; ?>">
                                                                ...
                                                                <td class=" ">
                                                                 ...
                                                                 <td class=" ">
                                                                      <?php echo $row->user->get(1)->name; ?>
                                                                    
                                                                </td>
                                                                <td class=" ">
                                                                    
                                                                    
                                                                    <a href="<?php echo site_url("products/parent/order/parent_id/{$row->id}/view/order_detail") ?>">
                                                                        Productos
                                                                    </a>
